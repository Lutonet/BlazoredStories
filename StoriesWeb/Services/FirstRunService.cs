  ...
  public class FirstRunService : IFirstRunService
  {
    ...
    public async Task<ApiResponse<string>> CreateCountries()
    {
      if (await _context.Countries.AnyAsync())
      {
        ...
        {
          ErrorMessage = t["Already created"],
          Successful = false
        };
      };
    ...
    public async Task<ApiResponse<string>> CreateCategoryGroups()
    {
      ...
      try
      {
        ...
        return new ApiResponse<string>()
        {
          Data = "List of category groups created successfuly"
        };
      }
      catch (Exception ex)
      {
    ...
    public async Task<ApiResponse<string>> CreateCategories()
    {
      ...
      try
      {
        ...
        return new ApiResponse<string>
        {
          Data="Categories added successfuly"
        };
      }
      catch (Exception ex)
      {
        _logger.LogError("Couldn't create categories table", ex);
        return new ApiResponse<string>()
        {
          Successful = false,
          ErrorMessage = "Couldn't create categories table"
        };
      }
    }
    ...
    public async Task<ApiResponse<string>> CreateLanguagesTable()
    {
      ...
      LibreLanguages.Add(new Language() { Code = "sv", Name="Sweish", Flag="https://flagcdn.com/w320/se.png" });
      ...
      catch (Exception ex)
      {
        ...
        return new ApiResponse<string>()
        {
          ErrorMessage = "Error creating language table",
          Successful = false
        };
      }
    }
    ...
    public async Task<ApiResponse<string>> CreateAdministrator(AdministratorDto administrator)
    {
      ...
      try
      {
        ...
        if (setup == null)
        {
          response.ErrorMessage="Can't open existing setup";
          response.Successful = false;
          return response;
        }
